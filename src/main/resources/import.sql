...
--PRODUCTOS
insert into PRODUCTOS(CALIDAD_PRODU,FECHA_INGRESO_PRODU,IMAGEN_PRODU,NOMBRE_PRODU,PRECIO_PRODU,STOCK_PRODU,TIPO_COMERCIALIZACION_PRODU,ID_PROD) values (5,TO_DATE(SYSDATE),EMPTY_BLOB(),'Manzana',50,5000,'E',1);