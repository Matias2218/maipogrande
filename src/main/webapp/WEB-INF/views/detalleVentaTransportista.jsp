							...
							<section class="page-section-one" >
								...
								<c:if test="${venta.estadoVenta eq 'T'.charAt(0)}">
									<div class="alert alert-success mb-0" role="alert">
										<div class="container">
											Los productos han sido seleccionados, y pasaran al proceso de <strong>transporte</strong>.
										</div>
									</div>
								</c:if>
								<div class="container">
										...
										<!-- FIN DESTINO Y ORIGEN -->
													...
													<table class="table table-sm table-borderless">
														...
														<tr>
															...
															<td class="lead p-0">${ofertaTran.transportista.nombreTran} ${ofertaTran.transportista.apellidosTran}</td>
														</tr>
														<tr>
															...
															<tr>
																...
																<td class="text-right font-weight-bold"><h5
																	...
																	$<fmt:formatNumber type="number"
																					   value="${ofertaTran.precioOfertaOfert}"></fmt:formatNumber></h5>
																</td>
															</tr>
														</table>
													</div>
