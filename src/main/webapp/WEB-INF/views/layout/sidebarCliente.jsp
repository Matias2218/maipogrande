			...
			<div class="sidebar-header">
				...
				<div class="user-info">
					<span class="user-name"> <strong>${nombre}
							${apellido}</strong>
					</span> <span class="user-role">Cliente <c:if
							test="${tipo eq 'E'.charAt(0)}">Externo</c:if> <c:if
							test="${tipo eq 'I'.charAt(0)}">Interno</c:if>
					</span> <span class="user-status"> <span
						class="badge badge-pill badge-success">0</span> <span>Ventas
							en proceso</span>
					</span>
				</div>
			</div>
